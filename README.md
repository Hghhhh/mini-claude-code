...
> 不是源码导览，是设计原理。每天一个模块，提炼一个核心实现技巧。
> 适合人群：想深入理解 Agent CLI 工程实现的同学（有服务端经验，AI Agent 零基础即可）。
> 推荐学习方式：clone本仓库和claudecode源码到本地，让AI（claudecode、openclaw等）按照day0-day13的内容，每天定时推送当天的课程到你的IM（钉钉、飞书等），有不懂的直接跟AI交流，把AI当成你的一对一教师，无痛学习。
---
